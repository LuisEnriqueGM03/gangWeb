    ...
    <div className="min-h-screen relative" style={{ background: 'linear-gradient(to bottom right, rgb(10, 35, 40), rgb(29, 126, 115), rgb(10, 35, 40))' }}>
      ...
      <div className="relative z-10 container mx-auto px-4 py-8 pt-32">
        ...
        <div className="max-w-6xl mx-auto mb-8">
          <div className="backdrop-blur-xl bg-white/10 rounded-2xl shadow-2xl border border-white/10 p-6" style={{ boxShadow: '0 25px 50px -12px rgba(59, 185, 171, 0.3)' }}>
            <div className="relative">
              ...
              <input
                type="text"
                placeholder="Buscar items por nombre, descripción o tipo..."
                value={searchTerm}
        ...
        <div className="max-w-6xl mx-auto mb-8">
          <div className="backdrop-blur-xl bg-white/10 rounded-2xl shadow-2xl border border-white/10 p-6" style={{ boxShadow: '0 25px 50px -12px rgba(59, 185, 171, 0.3)' }}>
            <div className="flex items-center gap-3 mb-4">
              ...
              <h3 className="text-xl font-semibold text-white">Filtrar por Tipo de Robo</h3>
            </div>
        ...
        {!loading && (
          <div className="max-w-6xl mx-auto space-y-6">
            {items
              ...
              <div
                key={item.id}
                className="backdrop-blur-xl bg-white/10 rounded-3xl shadow-2xl border border-white/10 overflow-hidden transform hover:scale-[1.02] transition-all duration-300"
                style={{ boxShadow: '0 25px 50px -12px rgba(59, 185, 171, 0.3)' }}
              >
                <div className="flex flex-col md:flex-row">
                  {/* Imagen a la izquierda */}
                  <div className="md:w-1/3 w-full bg-gradient-to-br from-gray-800 to-gray-900 flex items-center justify-center p-8">
                    {item.image ? (
                      <img
                        src={item.image}
                        alt={item.name}
                        className="w-full h-64 object-contain rounded-lg drop-shadow-2xl"
                      />
                    ) : (
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 pt-4">
                        ...
                        <div className="backdrop-blur-md bg-white/5 rounded-xl p-4 border border-white/10">
                          <div className="flex items-center gap-3 mb-2">
                            ...
                            <span className="text-sm font-semibold text-white uppercase tracking-wider">Precio</span>
                          </div>
                          <p className="text-3xl font-bold text-white">${item.precio.toLocaleString()}</p>
                        </div>
                        ...
                        <div className="backdrop-blur-md bg-white/5 rounded-xl p-4 border border-white/10">
                          <div className="flex items-center gap-3 mb-2">
                            ...
                            <span className="text-sm font-semibold text-white uppercase tracking-wider">Maximo</span>
                          </div>
                          <p className="text-3xl font-bold text-white">{item.max}</p>
                          <p className="text-0.5xl font-bold text-white">Por Reinicio</p>
                        </div>
                        ...
                        <div className="backdrop-blur-md bg-white/5 rounded-xl p-4 border border-white/10">
                          <div className="flex items-center gap-3 mb-2">
                            ...
                            <span className="text-sm font-semibold text-white uppercase tracking-wider">Robo</span>
                          </div>
                          <p className="text-2xl font-bold text-white">{item.tipo}</p>
                        </div>
                      </div>
                    </div>
                  </div>
